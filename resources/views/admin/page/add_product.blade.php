...
<!-- Plugins css -->
<link href="{{config('app.administrator')}}/libs/dropzone/dropzone.css" rel="stylesheet" type="text/css" />
...
<script src="{{config('app.administrator')}}/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    ...
    <!-- ckeditor -->
    <script src="{{config('app.administrator')}}/libs/@ckeditor/ckeditor5-build-classic/build/ckeditor.js"></script>

    <!-- dropzone js -->
    <script src="{{config('app.administrator')}}/libs/dropzone/dropzone-min.js"></script>

    <script src="{{config('app.administrator')}}/js/pages/ecommerce-product-create.init.js"></script>
