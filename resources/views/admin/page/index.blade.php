...
@section('style')
<!-- App favicon -->
<link rel="shortcut icon" href="{{config('app.administrator')}}/images/favicon.ico">

<!-- jsvectormap css -->
<link href="{{config('app.administrator')}}/libs/jsvectormap/css/jsvectormap.min.css" rel="stylesheet" type="text/css" />

<!--Swiper slider css-->
<link href="{{config('app.administrator')}}/libs/swiper/swiper-bundle.min.css" rel="stylesheet" type="text/css" />

<!-- Layout config Js -->
<script src="{{config('app.administrator')}}/js/layout.js"></script>
<!-- Bootstrap Css -->
<link href="{{config('app.administrator')}}/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<!-- Icons Css -->
<link href="{{config('app.administrator')}}/css/icons.min.css" rel="stylesheet" type="text/css" />
<!-- App Css-->
<link href="{{config('app.administrator')}}/css/app.min.css" rel="stylesheet" type="text/css" />
<!-- custom Css-->
<link href="{{config('app.administrator')}}/css/custom.min.css" rel="stylesheet" type="text/css" />
...
@section('javascript')
    <!-- JAVASCRIPT -->
    <script src="{{config('app.administrator')}}/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="{{config('app.administrator')}}/libs/simplebar/simplebar.min.js"></script>
    <script src="{{config('app.administrator')}}/libs/node-waves/waves.min.js"></script>
    <script src="{{config('app.administrator')}}/libs/feather-icons/feather.min.js"></script>
    <script src="{{config('app.administrator')}}/js/pages/plugins/lord-icon-2.1.0.js"></script>
    <script src="{{config('app.administrator')}}/js/plugins.js"></script>

    <!-- apexcharts -->
    <script src="{{config('app.administrator')}}/libs/apexcharts/apexcharts.min.js"></script>

    <!-- Vector map-->
    <script src="{{config('app.administrator')}}/libs/jsvectormap/js/jsvectormap.min.js"></script>
    <script src="{{config('app.administrator')}}/libs/jsvectormap/maps/world-merc.js"></script>

    <!--Swiper slider js-->
    <script src="{{config('app.administrator')}}/libs/swiper/swiper-bundle.min.js"></script>

    <!-- Dashboard init -->
    <script src="{{config('app.administrator')}}/js/pages/dashboard-ecommerce.init.js"></script>

    <!-- App js -->
    <script src="{{config('app.administrator')}}/js/app.js"></script>
@endsection
